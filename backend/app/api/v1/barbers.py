...
async def create_barber(barber: schemas.BarberCreate, db: Session = Depends(get_db)):
    """Create a new barber."""
...
async def update_barber(barber_id: int, barber: schemas.BarberUpdate, db: Session = Depends(get_db)):
    """Update a barber."""
